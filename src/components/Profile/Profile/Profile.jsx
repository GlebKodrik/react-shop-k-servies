...
export const Profile = (props) => {
    ...
    return <div>
        <div className={["profileContainer", s.profileData].join(' ')}>
            <div>
                <div className={s.profile__avatar}>
                    <label className={s.profilePhoto__label} >
                        <span className={s.profilePhoto__text}>Изменить фото</span>
                        <input id="file-input" type={"file"} onChange={onMainPhotoSelected}/>
                    </label>
                    <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} autoComplete="off">
                <div className={s.profileEditData}>
                    <div className={s.profileDataTitle}>Персональные данные</div>
                    <div>
                        {!edit ?

...
export const Requisites = () => {
  return (
    <div>
      <div className={cn("title" , s.title)}><span c>К</span>-сервис</div>
      <div className={s.requisites}>
        <p>Реквизиты компании</p>
        <ul>
          <li><span>Счет №:</span> 40702810901390000018</li>
          <li><span>Наименование:</span> ООО "К-Сервис"</li>
          <li><span>ИНН:</span>7807208112</li>
          <li><span>КПП:</span> 780701001</li>
        </ul> 
        <p>Реквизиты банка</p>
        <ul>
        ...
        <p>Генеральный директор Кодрик Марина Олеговна
